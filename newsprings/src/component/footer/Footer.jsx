...
<div className='footer '>
  ...
  <div className="about">
        ...
        <h3>About</h3>
        <p>
            RCCG Newspring is a vibrant and welcoming place of worship, love, and transformation, 
            where people from all walks of life come together to experience the presence of God. 
            Rooted in the teachings of Jesus Christ, we are committed to spreading the gospel with passion and purpose, 
            empowering individuals to grow spiritually, live purposefully, and impact their communities positively. 
            At RCCG Newspring, every soul is valued.</p>
    </div>
